...
///     skipmin: Some(5), // Skip after 5 seconds
///     skipafter: Some(5),
///     playmethod: Some(vec![1]), // Auto-play, sound on
///     playend: Some(1), // On completion or when terminated
///     clktype: Some(1), // Clickable
///     ..Default::default()
/// };
/// # Ok(())
/// # }
...
pub struct VideoPlacement {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    #[builder(default)]
    pub comp: Option<Vec<serde_json::Value>>,
...
mod tests {
    ...
    fn test_video_placement_with_mime_types() {
        let video = VideoPlacement {
            mime: Some(vec!["video/mp4".to_string(), "video/webm".to_string()]),
            ..Default::default()
        };
    ...
    fn test_video_placement_builder() {
        let video = VideoPlacementBuilder::default()
            .ptype(Some(1))
            .mindur(Some(5))
            .maxdur(Some(30))
            .build()
